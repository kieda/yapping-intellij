...
public class YappingFScopeImpl extends ASTWrapperPsiElement implements YappingFScope {

  public YappingFScopeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YappingVisitor visitor) {
    visitor.visitFScope(this);
  }
  ...
  public YappingFScope getFScope() {
    return findChildByClass(YappingFScope.class);
  }
