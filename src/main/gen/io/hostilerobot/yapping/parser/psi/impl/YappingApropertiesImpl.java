...
public class YappingApropertiesImpl extends ASTWrapperPsiElement implements YappingAproperties {

  public YappingApropertiesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YappingVisitor visitor) {
    visitor.visitAproperties(this);
  }
