...
public class YappingRpropertiesImpl extends ASTWrapperPsiElement implements YappingRproperties {

  public YappingRpropertiesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YappingVisitor visitor) {
    visitor.visitRproperties(this);
  }
