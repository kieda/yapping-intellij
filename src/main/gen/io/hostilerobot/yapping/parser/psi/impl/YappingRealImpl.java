...
public class YappingRealImpl extends ASTWrapperPsiElement implements YappingReal {

  public YappingRealImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public YappingDecimal getDecimal() {
