...
public class YappingFSegmentMultiImpl extends ASTWrapperPsiElement implements YappingFSegmentMulti {

  public YappingFSegmentMultiImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YappingVisitor visitor) {
    visitor.visitFSegmentMulti(this);
  }
