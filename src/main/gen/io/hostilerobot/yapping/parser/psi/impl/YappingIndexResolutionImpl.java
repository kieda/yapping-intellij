...
public class YappingIndexResolutionImpl extends ASTWrapperPsiElement implements YappingIndexResolution {

  public YappingIndexResolutionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YappingVisitor visitor) {
    visitor.visitIndexResolution(this);
  }
