...
public class YappingCpropertiesImpl extends ASTWrapperPsiElement implements YappingCproperties {

  public YappingCpropertiesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YappingVisitor visitor) {
    visitor.visitCproperties(this);
  }
