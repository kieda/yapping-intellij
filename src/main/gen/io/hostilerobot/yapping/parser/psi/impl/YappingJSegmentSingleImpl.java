...
public class YappingJSegmentSingleImpl extends ASTWrapperPsiElement implements YappingJSegmentSingle {

  public YappingJSegmentSingleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YappingVisitor visitor) {
    visitor.visitJSegmentSingle(this);
  }
