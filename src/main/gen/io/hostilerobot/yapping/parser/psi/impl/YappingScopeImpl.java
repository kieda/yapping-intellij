...
public class YappingScopeImpl extends ASTWrapperPsiElement implements YappingScope {

  public YappingScopeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public YappingIndexResolution getIndexResolution() {
    return findChildByClass(YappingIndexResolution.class);
  }
